...
AND ((pdds_Status = ''WIP'') OR (pdds_Status = ''PREVIEW'') OR (pdds_Status = ''RELEASED'' AND CONTEXT__USER_CONTEXT_idr=(SELECT CONTEXT_id from T_EDIP_CONTEXT where ContextName=''A380_Admin_Data'')) )             
