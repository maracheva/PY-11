-- Role Data Admin – Attributes rights - BDDS
...
DECLARE @BDDSCR_id int
DECLARE @CONTEXT_id INT

SELECT @CONTEXT_id = CONTEXT_id FROM T_EDIP_CONTEXT WHERE ContextName='A380_Admin_data'
SELECT @M_ATTRIBUTE_id = ATTRIBUTE_id FROM T_EDIP_ATTRIBUTE WHERE AttributeLabel = 'Maturity Level' AND AttributeName = 'BDDSMaturityLevel'
SELECT @CN_ATTRIBUTE_id = ATTRIBUTE_id FROM T_EDIP_ATTRIBUTE WHERE AttributeLabel = 'CN' AND AttributeName = 'BDDSCN'
SELECT @C_ATTRIBUTE_id = ATTRIBUTE_id FROM T_EDIP_ATTRIBUTE WHERE AttributeLabel = 'Is this a cancelled drawing ?' AND AttributeName = 'BDDSCancelled'
SELECT @ART_ATTRIBUTE_id = ATTRIBUTE_id FROM T_EDIP_ATTRIBUTE WHERE AttributeLabel = 'Associated Routing Table' AND AttributeName = 'BDDSAssociatedRoutingTable'
SELECT @MODMP_ATTRIBUTE_id = ATTRIBUTE_id FROM T_EDIP_ATTRIBUTE WHERE AttributeLabel = 'Applicability' AND AttributeName = 'BDDSMODMP'
SELECT @BDDSCR_id = ATTRIBUTE_id FROM T_EDIP_ATTRIBUTE WHERE AttributeLabel = 'CR' AND AttributeName = 'BDDSCR'
...
IF NOT EXISTS(SELECT * FROM T_EDIP_LINK_ATTRIBUTE__CONTEXT WHERE ATTRIBUTE__CONTEXT_ATTRIBUTE_idr=@ART_ATTRIBUTE_id AND ATTRIBUTE__CONTEXT_CONTEXT_idr=@CONTEXT_id)
BEGIN
INSERT INTO T_EDIP_LINK_ATTRIBUTE__CONTEXT 
(ATTRIBUTE__CONTEXT_ATTRIBUTE_idr, ATTRIBUTE__CONTEXT_CONTEXT_idr, AttributeContextReadMode, AttributeContextWriteMode) 
VALUES
(@ART_ATTRIBUTE_id, @CONTEXT_id, 1, 1)
END
ELSE
BEGIN
UPDATE T_EDIP_LINK_ATTRIBUTE__CONTEXT SET AttributeContextReadMode =1, AttributeContextWriteMode=1 WHERE
ATTRIBUTE__CONTEXT_ATTRIBUTE_idr=@ART_ATTRIBUTE_id AND ATTRIBUTE__CONTEXT_CONTEXT_idr=@CONTEXT_id
END
...
IF NOT EXISTS(SELECT * FROM T_EDIP_LINK_ATTRIBUTE__CONTEXT WHERE ATTRIBUTE__CONTEXT_ATTRIBUTE_idr=@BDDSCR_id AND ATTRIBUTE__CONTEXT_CONTEXT_idr=@CONTEXT_id)
BEGIN
INSERT INTO T_EDIP_LINK_ATTRIBUTE__CONTEXT 
(ATTRIBUTE__CONTEXT_ATTRIBUTE_idr, ATTRIBUTE__CONTEXT_CONTEXT_idr, AttributeContextReadMode, AttributeContextWriteMode) 
VALUES
(@BDDSCR_id, @CONTEXT_id, 1, 1)
END
ELSE
BEGIN
UPDATE T_EDIP_LINK_ATTRIBUTE__CONTEXT SET AttributeContextReadMode =1, AttributeContextWriteMode=1 WHERE
ATTRIBUTE__CONTEXT_ATTRIBUTE_idr=@BDDSCR_id AND ATTRIBUTE__CONTEXT_CONTEXT_idr=@CONTEXT_id
END
