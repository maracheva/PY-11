...
AND ((WddsStatus = ''WIP'') OR (WddsStatus = ''PREVIEW'') OR (WddsStatus = ''RELEASED'' AND CONTEXT__USER_CONTEXT_idr=(SELECT CONTEXT_id from T_EDIP_CONTEXT where ContextName=''A350_Admin_Data'')) )                          
