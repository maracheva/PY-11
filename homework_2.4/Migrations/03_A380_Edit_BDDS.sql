...
AND ((BDDSStatus = ''WIP'') OR (BDDSStatus = ''PREVIEW'') OR (BDDSStatus = ''RELEASED'' AND CONTEXT__USER_CONTEXT_idr=(SELECT CONTEXT_id from T_EDIP_CONTEXT where ContextName=''A380_Admin_Data'')) )                              
